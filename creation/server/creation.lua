-- TODO (HIGH PRIORITY): Rewrite these handlers to fully align with our framework standards
-- Currently they duplicate code and bypass framework conventions. Keep functionality but refactor later.
